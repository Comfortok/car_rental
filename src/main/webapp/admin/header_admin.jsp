...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <button type="button" class="btn btn-link" data-toggle="modal" data-target=".bd-example-modal-sm">
        <fmt:message key="locale.language" bundle="${loc}"/>
    </button>
        ...
        <ul class="navbar-nav" >
            ...
            <c:choose>
                <c:when test="${not empty sessionScope.user}">
                    ...
                    <li class="navitem">
                        <a class="nav-link" href="${pageContext.request.contextPath}/mainServlet?command=showAllOrders">Orders</a>
                    </li>
                </c:when>
                <c:otherwise>
                    <li class="navitem">
                        <a class="nav-link" href="../login.jsp"><fmt:message key="page.signin" bundle="${loc}"/></a>
                    </li>
                </c:otherwise>
            </c:choose>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><fmt:message key="locale.language" bundle="${loc}"/></h5>
            ...
            <div class="modal-body">
                <div class="container" align="center">
                    <table>
                        <tr>
                            <td>
                                <a href="${pageContext.request.contextPath}/mainServlet?command=RU" class="rounded mx-auto d-block">
                                    <img src="${pageContext.request.contextPath}/img/russia-flag-icon.png" width="72" height="72" alt="rf">
                                </a>
                            </td>
                            <td>
                                <a href="${pageContext.request.contextPath}/mainServlet?command=EN" class="rounded mx-auto d-block">
                                    <img src="${pageContext.request.contextPath}/img/uk-flag-icon.png" width="72" height="72" alt="uk">
                                </a>
                            </td>
                        </tr>
                    </table>
