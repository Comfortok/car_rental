    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <li class="navitem">
                        <a class="nav-link" href="${pageContext.request.contextPath}/mainServlet?command=showSignInPage"><fmt:message key="header.signin" bundle="${loc}"/></a>
                    </li>
                    <li class="navitem">
                        <a class="nav-link" href="${pageContext.request.contextPath}/mainServlet?command=showSignUpPage"><fmt:message key="header.signup" bundle="${loc}"/></a>
                    </li>
                </c:otherwise>
            </c:choose>
        </ul>
